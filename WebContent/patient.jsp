    ...
    <div class="Container">
      ...
      <h3 text-align:center>Book An Appointment</h3>
        ...
        <form action="DoctorSeachServlet" method="post">  
                ...
                <input type="text" id="doc" name="spec" placeholder="Search" class="bigbox uisearch" onkeyup="city()">
                </div>
                <div class="col-xs-12 col-sm-3">
                 <input type="submit" id="b"  placeholder="Search" value="Search" class="box">
                </div>
