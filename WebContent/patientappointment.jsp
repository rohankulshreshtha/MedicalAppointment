    ...
    <div class="header-bottom ">
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--horatio">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item menu__item--current"><a href="PatientAppointmentServlet" class="menu__link">My Appointment</a></li> 
      ...
      <thead class="thead-inverse">
       <tr>
            ...
            <td><a href="CancelAppointment?app_id=${appointment.app_id}"><input type="button" id="b" class="button btn-info" value="Cancel Appointment"></a> <br>
                        </td>
        	</tr>
    </c:forEach>
</table>
