					...
					<nav class="menu menu--horatio">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="mydetails.jsp" class="menu__link">My Details</a></li>
							 <li class="menu__item  menu__item--current"><a href="feedback.jsp" class="menu__link">Feedback</a></li> 
		...
		<div class="contact-grids">
			...
			<div class="col-md-6 contact-grid ">
				<form action="#" method="post">
					...
					<input type="text" name="Appointmentid" value="Appointmentid" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Appointmentid';}" required="">
