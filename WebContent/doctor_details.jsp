    ...
    <div class="header wow zoomIn">
        <div class="container">
            <div class="header_right">
                <div class="login">
                <ul> 
                    <li><a href="#"><span aria-hidden="true"><img src="icon/user.png" width="30px" height="40px"></span>       
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--horatio">
						<ul class="nav navbar-nav menu__list">
                            ...
                            <li class="menu__item menu__item--current"><a href="doctor_details.jsp" class="menu__link">My Details</a></li> 
						</ul>
					</nav>
				</div>
			</nav>
...
<div class="container">
        ...
        <div class="row row-content">
            <div class="col-sm-3">
                <img src="icon/user.png" width="200px" height="200px">
            </div>
            <div class="col-sm-9">
               
			
          
                <h3>Dr.   <%= doc.getName() + " "  %></h3><br>
                <h5><%=doc.getSpec()  %></h5>
                <p> <%=doc.getLocation()  %></p>
                <p> <%=doc.getExp()  %></p>
                   <%=doc.getDescription() %> <br>
                    Free-Slots<input type="button" class="button btn-info" value="Modify Schedule"><br><br>
