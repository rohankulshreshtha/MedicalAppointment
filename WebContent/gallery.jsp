...
<html>
<head>
<title>MedicalAppointment | Gallery :: w3layouts</title>
<!-- for-mobile-apps -->
	...
	<div class="container">
		<div class="header_left" data-wow-duration="2s" data-wow-delay="0.5s">
			<ul>
				...
				<li><a href="manishajmera@gmail.com"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>info@example.com</a></li>
			</ul>
		</div>
				...
				<div class="collapse navbar-collapse nav-wil links" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--horatio">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item menu__item--current"><a href="gallery.jsp" class="menu__link">Gallery</a></li> 
