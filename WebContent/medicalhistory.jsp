...
<body>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--horatio">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item menu__item--current"><a href="MedicalHistoryServlet" class="menu__link">Medical History</a></li> 
    ...
    <div class="row row-content">
      ...
      <thead class="thead-inverse">
       <tr>
                 <strong><th >Doctor_id</th></strong>
                  <strong><th >Name</th></strong>
                 <strong> <th>Application No.</th></strong>
                  <strong><th>Time-Slot</th></strong>
                 <strong> <th >Date</th></strong>
                 <strong> <th >next-date</th></strong>
                 <strong><th>Medicines</th></strong>
                 <strong><th>Feedback</th></strong>
       </tr>
        </thead>
            ...
            <td><fmt:formatDate type="date" value="${appointment.date}" /></td>
             <td><fmt:formatDate type="date" value="${appointment.next_date}" /></td>
          <td><c:out value="${appointment.medicine}" /></td>
           
             <td><a href="FeedbackServlet?doc_id=${appointment.doc_id}&pat_id=<%= pat.getId()%>"><input type="button" id="b" class="button btn-info" value="Give feedback"></a> <br>
