...
<div class="container">
      ...
      <thead class="thead-inverse">
       <tr>
                 ...
                 <strong> <th >Give Prescription</th></strong>
       </tr>
        </thead>
        ...
        <tr>
            ...
            <td><a href="PrescriptionServlet?app_id=${appointment.app_id}&pat_id=${appointment.pat_id}&doc_id=${appointment.doc_id}">Prescribe</a></td>
        </tr>
    </c:forEach>
